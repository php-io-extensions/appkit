...
zend_class_entry *appkit_ns_nsdateformatter_nsdateformatter_ce;
...
zend_class_entry *appkit_ns_nsindexset_nsindexset_ce;
...
zend_class_entry *appkit_ns_nsopenglcontext_nsopenglcontext_ce;
zend_class_entry *appkit_ns_nsopenglpixelformat_nsopenglpixelformat_ce;
zend_class_entry *appkit_ns_nsopenglview_nsopenglview_ce;
...
static PHP_MINIT_FUNCTION(appkit)
{
	...
	ZEPHIR_INIT(AppKit_NS_NSDateFormatter_NSDateFormatter);
	...
	ZEPHIR_INIT(AppKit_NS_NSIndexSet_NSIndexSet);
	...
	ZEPHIR_INIT(AppKit_NS_NSOpenGLContext_NSOpenGLContext);
	ZEPHIR_INIT(AppKit_NS_NSOpenGLPixelFormat_NSOpenGLPixelFormat);
	ZEPHIR_INIT(AppKit_NS_NSOpenGLView_NSOpenGLView);
