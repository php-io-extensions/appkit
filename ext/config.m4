...
if test "$PHP_APPKIT" = "yes"; then
	...
	APPKIT_SHARED_LIBADD="$APPKIT_SHARED_LIBADD -framework Foundation -framework AppKit -framework QuartzCore -framework CoreImage -framework Symbols -framework AVFoundation -framework AVKit"
