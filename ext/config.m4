...
if test "$PHP_APPKIT" = "yes"; then
	...
	APPKIT_SHARED_LIBADD="$APPKIT_SHARED_LIBADD -framework Foundation -framework AppKit -framework QuartzCore -framework CoreImage -framework Symbols -framework AVFoundation -framework AVKit -framework GameController"

	AC_DEFINE(HAVE_APPKIT, 1, [Whether you have Appkit])
	appkit_sources="appkit.c kernel/main.c kernel/memory.c kernel/exception.c kernel/debug.c kernel/backtrace.c kernel/object.c kernel/array.c kernel/string.c kernel/fcall.c kernel/require.c kernel/file.c kernel/operators.c kernel/math.c kernel/concat.c kernel/variables.c kernel/filter.c kernel/iterator.c kernel/time.c kernel/exit.c appkit/av/avplayer/avplayer.zep.c
	appkit/av/avplayerview/avplayerview.zep.c
	appkit/bridge/bridge.zep.c
	appkit/gc/gccontroller/gccontroller.zep.c
	appkit/gc/gccontrolleraxisinput/gccontrolleraxisinput.zep.c
	appkit/gc/gccontrollerbuttoninput/gccontrollerbuttoninput.zep.c
	appkit/gc/gccontrollerdirectionpad/gccontrollerdirectionpad.zep.c
	appkit/gc/gcextendedgamepad/gcextendedgamepad.zep.c
	appkit/gc/gcmicrogamepad/gcmicrogamepad.zep.c
	appkit/ns/nsalert/nsalert.zep.c
	appkit/ns/nsapplication/nsapplication.zep.c
	appkit/ns/nsattributedstring/nsattributedstring.zep.c
	...
	appkit/ns/nsdateformatter/nsdateformatter.zep.c
	...
	appkit/ns/nsindexset/nsindexset.zep.c
	...
	appkit/ns/nsopenglcontext/nsopenglcontext.zep.c
	appkit/ns/nsopenglpixelformat/nsopenglpixelformat.zep.c
	appkit/ns/nsopenglview/nsopenglview.zep.c
	...
	shared_objects_appkit="$shared_objects_appkit src/av-player.lo src/av-playerview.lo src/ca-layer.lo src/gc-controller.lo src/gc-controlleraxisinput.lo src/gc-controllerbuttoninput.lo src/gc-controllerdirectionpad.lo src/gc-extendedgamepad.lo src/gc-microgamepad.lo src/ns-alert.lo src/ns-application.lo src/ns-attributedstring.lo src/ns-box.lo src/ns-bridge.lo src/ns-button.lo src/ns-cell.lo src/ns-clipview.lo src/ns-collectionview.lo src/ns-collectionviewflowlayout.lo src/ns-collectionviewgridlayout.lo src/ns-collectionviewlayout.lo src/ns-color.lo src/ns-colorwell.lo src/ns-combobox.lo src/ns-comboboxcell.lo src/ns-control.lo src/ns-dateformatter.lo src/ns-datepicker.lo src/ns-datepickercell.lo src/ns-event.lo src/ns-font.lo src/ns-fontdescriptor.lo src/ns-gridview.lo src/ns-image.lo src/ns-imagerep.lo src/ns-imageview.lo src/ns-indexset.lo src/ns-layoutmanager.lo src/ns-menu.lo src/ns-menuitem.lo src/ns-notificationcenter.lo src/ns-openglcontext.lo src/ns-openglpixelformat.lo src/ns-openglview.lo src/ns-openpanel.lo src/ns-outlineview.lo src/ns-pathcell.lo src/ns-pathcomponentcell.lo src/ns-pathcontrol.lo src/ns-pathcontrolitem.lo src/ns-popover.lo src/ns-popupbutton.lo src/ns-progressindicator.lo src/ns-responder.lo src/ns-savepanel.lo src/ns-screen.lo src/ns-scrollview.lo src/ns-searchfield.lo src/ns-searchfieldcell.lo src/ns-securetextfield.lo src/ns-segmentedcell.lo src/ns-segmentedcontrol.lo src/ns-slider.lo src/ns-slidercell.lo src/ns-splitview.lo src/ns-stackview.lo src/ns-statusbar.lo src/ns-statusbarbutton.lo src/ns-statusitem.lo src/ns-stepper.lo src/ns-steppercell.lo src/ns-switch.lo src/ns-tablecellview.lo src/ns-tablecolumn.lo src/ns-tableheadercell.lo src/ns-tableheaderview.lo src/ns-tablerowview.lo src/ns-tableview.lo src/ns-tabview.lo src/ns-tabviewitem.lo src/ns-text.lo src/ns-textcontainer.lo src/ns-textfield.lo src/ns-textfieldcell.lo src/ns-textstorage.lo src/ns-textview.lo src/ns-toolbar.lo src/ns-toolbaritem.lo src/ns-toolbaritemgroup.lo src/ns-url.lo src/ns-view.lo src/ns-viewcontroller.lo src/ns-visualeffectview.lo src/ns-window.lo"
	PHP_ADD_BUILD_DIR([$ext_builddir/kernel/])
	for dir in "appkit/av/avplayer appkit/av/avplayerview appkit/bridge appkit/gc/gccontroller appkit/gc/gccontrolleraxisinput appkit/gc/gccontrollerbuttoninput appkit/gc/gccontrollerdirectionpad appkit/gc/gcextendedgamepad appkit/gc/gcmicrogamepad appkit/ns/nsalert appkit/ns/nsapplication appkit/ns/nsattributedstring appkit/ns/nsbox appkit/ns/nsbutton appkit/ns/nscell appkit/ns/nsclipview appkit/ns/nscollectionview appkit/ns/nscollectionviewflowlayout appkit/ns/nscollectionviewflowlayoutinvalidationcontext appkit/ns/nscollectionviewgridlayout appkit/ns/nscollectionviewitem appkit/ns/nscollectionviewlayout appkit/ns/nscollectionviewlayoutattributes appkit/ns/nscollectionviewlayoutinvalidationcontext appkit/ns/nscollectionviewupdateitem appkit/ns/nscolor appkit/ns/nscolorwell appkit/ns/nscombobox appkit/ns/nscomboboxcell appkit/ns/nscontrol appkit/ns/nsdateformatter appkit/ns/nsdatepicker appkit/ns/nsdatepickercell appkit/ns/nsevent appkit/ns/nsfont appkit/ns/nsfontdescriptor appkit/ns/nsgridcell appkit/ns/nsgridcolumn appkit/ns/nsgridrow appkit/ns/nsgridview appkit/ns/nsimage appkit/ns/nsimagerep appkit/ns/nsimagesymbolconfiguration appkit/ns/nsimageview appkit/ns/nsindexset appkit/ns/nslayoutmanager appkit/ns/nsmenu appkit/ns/nsmenuitem appkit/ns/nsnotificationcenter appkit/ns/nsopenglcontext appkit/ns/nsopenglpixelformat appkit/ns/nsopenglview appkit/ns/nsopenpanel appkit/ns/nsoutlineview appkit/ns/nspathcell appkit/ns/nspathcomponentcell appkit/ns/nspathcontrol appkit/ns/nspathcontrolitem appkit/ns/nspopover appkit/ns/nspopupbutton appkit/ns/nsprogressindicator appkit/ns/nsresponder appkit/ns/nssavepanel appkit/ns/nsscreen appkit/ns/nsscrollview appkit/ns/nssearchfield appkit/ns/nssearchfieldcell appkit/ns/nssecuretextfield appkit/ns/nssecuretextfieldcell appkit/ns/nssegmentedcell appkit/ns/nssegmentedcontrol appkit/ns/nsslider appkit/ns/nsslidercell appkit/ns/nssplitview appkit/ns/nsstackview appkit/ns/nsstatusbar appkit/ns/nsstatusbarbutton appkit/ns/nsstatusitem appkit/ns/nsstepper appkit/ns/nssteppercell appkit/ns/nsswitch appkit/ns/nstablecellview appkit/ns/nstablecolumn appkit/ns/nstableheadercell appkit/ns/nstableheaderview appkit/ns/nstablerowview appkit/ns/nstableview appkit/ns/nstabview appkit/ns/nstabviewitem appkit/ns/nstext appkit/ns/nstextcontainer appkit/ns/nstextfield appkit/ns/nstextfieldcell appkit/ns/nstextstorage appkit/ns/nstextview appkit/ns/nstoolbar appkit/ns/nstoolbaritem appkit/ns/nstoolbaritemgroup appkit/ns/nsurl appkit/ns/nsview appkit/ns/nsviewcontroller appkit/ns/nsvisualeffectview appkit/ns/nswindow appkit/quartzcore/calayer"; do
