...
{
	ZEPHIR_REGISTER_CLASS(AppKit\\NS\\NSAccessibilityCustomRotorItem, NSAccessibilityCustomRotorItem, appkit, ns_nsaccessibilitycustomrotoritem_nsaccessibilitycustomrotoritem, appkit_ns_nsaccessibilitycustomrotoritem_nsaccessibilitycustomrotoritem_method_entry, 0);
