...
#include "src/ns-tableheaderview.h"
...
PHP_METHOD(AppKit_NS_NSTableHeaderView_NSTableHeaderView, initWithFrame)
{
	...
	RETURN_LONG(ns_nstableheaderview_init_with_frame(&_0, &_1, &_2, &_3));
}
...
PHP_METHOD(AppKit_NS_NSTableHeaderView_NSTableHeaderView, tableView)
{
	...
	ZVAL_LONG(&_0, handle);
	RETURN_LONG(ns_nstableheaderview_table_view(&_0));
}
...
PHP_METHOD(AppKit_NS_NSTableHeaderView_NSTableHeaderView, setTableView)
{
	...
	ns_nstableheaderview_set_table_view(&_0, &_1);
}
...
PHP_METHOD(AppKit_NS_NSTableHeaderView_NSTableHeaderView, draggedColumn)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &handle_param);
	ZVAL_LONG(&_0, handle);
	RETURN_LONG(ns_nstableheaderview_dragged_column(&_0));
}
...
PHP_METHOD(AppKit_NS_NSTableHeaderView_NSTableHeaderView, draggedDistance)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &handle_param);
	ZVAL_LONG(&_0, handle);
	RETURN_DOUBLE(ns_nstableheaderview_dragged_distance(&_0));
}
...
PHP_METHOD(AppKit_NS_NSTableHeaderView_NSTableHeaderView, resizedColumn)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &handle_param);
	ZVAL_LONG(&_0, handle);
	RETURN_LONG(ns_nstableheaderview_resized_column(&_0));
}
...
PHP_METHOD(AppKit_NS_NSTableHeaderView_NSTableHeaderView, headerRectOfColumn)
{
	...
	ZVAL_LONG(&_0, handle);
	ZVAL_LONG(&_1, column);
	ns_nstableheaderview_header_rect_of_column(&result, &_0, &_1);
	RETURN_CCTOR(&result);
}
...
PHP_METHOD(AppKit_NS_NSTableHeaderView_NSTableHeaderView, columnAtPoint)
{
	...
	ZVAL_DOUBLE(&_1, x);
	ZVAL_DOUBLE(&_2, y);
	RETURN_LONG(ns_nstableheaderview_column_at_point(&_0, &_1, &_2));
}
