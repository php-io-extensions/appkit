...
#include "src/ns-tableheadercell.h"
...
PHP_METHOD(AppKit_NS_NSTableHeaderCell_NSTableHeaderCell, initTextCell)
{
	...
	RETURN_MM_LONG(ns_nstableheadercell_init_text_cell(&string_));
}
...
PHP_METHOD(AppKit_NS_NSTableHeaderCell_NSTableHeaderCell, drawSortIndicatorWithFrameInViewAscendingPriority)
{
	...
	zval *handle_param = NULL, *x_param = NULL, *y_param = NULL, *width_param = NULL, *height_param = NULL, *controlView_param = NULL, *ascending_param = NULL, *priority_param = NULL, _0, _1, _2, _3, _4, _5, _6, _7;
	zend_long handle, controlView, priority;
	...
	ZEND_PARSE_PARAMETERS_END();
	zephir_fetch_params_without_memory_grow(8, 0, &handle_param, &x_param, &y_param, &width_param, &height_param, &controlView_param, &ascending_param, &priority_param);
	...
	ZVAL_BOOL(&_6, (ascending ? 1 : 0));
	ZVAL_LONG(&_7, priority);
	ns_nstableheadercell_draw_sort_indicator_with_frame_in_view_ascending_priority(&_0, &_1, &_2, &_3, &_4, &_5, &_6, &_7);
}
...
PHP_METHOD(AppKit_NS_NSTableHeaderCell_NSTableHeaderCell, sortIndicatorRectForBounds)
{
	...
	ZVAL_DOUBLE(&_3, width);
	ZVAL_DOUBLE(&_4, height);
	ns_nstableheadercell_sort_indicator_rect_for_bounds(&result, &_0, &_1, &_2, &_3, &_4);
	RETURN_CCTOR(&result);
}
