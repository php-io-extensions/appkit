...
{
	ZEPHIR_REGISTER_CLASS(AppKit\\NS\\NSOutlineViewDelegate, NSOutlineViewDelegate, appkit, ns_nsoutlineviewdelegate_nsoutlineviewdelegate, appkit_ns_nsoutlineviewdelegate_nsoutlineviewdelegate_method_entry, 0);
