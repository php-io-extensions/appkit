...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_appkit_ns_nsstatusbar_nsstatusbar_system, 0, 0, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_appkit_ns_nsstatusbar_nsstatusbar_wrap, 0, 1, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, nsStatusBarPtr, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_appkit_ns_nsstatusbar_nsstatusbar_destroy, 0, 1, IS_VOID, 0)

	ZEND_ARG_TYPE_INFO(0, bar, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_appkit_ns_nsstatusbar_nsstatusbar_nsstatusbar, 0, 1, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, bar, IS_LONG, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_appkit_ns_nsstatusbar_nsstatusbar_statusitemwithkind, 0, 2, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, bar, IS_LONG, 0)
...
ZEPHIR_INIT_FUNCS(appkit_ns_nsstatusbar_nsstatusbar_method_entry) {
	PHP_ME(AppKit_NS_NSStatusBar_NSStatusBar, system, arginfo_appkit_ns_nsstatusbar_nsstatusbar_system, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(AppKit_NS_NSStatusBar_NSStatusBar, wrap, arginfo_appkit_ns_nsstatusbar_nsstatusbar_wrap, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(AppKit_NS_NSStatusBar_NSStatusBar, destroy, arginfo_appkit_ns_nsstatusbar_nsstatusbar_destroy, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(AppKit_NS_NSStatusBar_NSStatusBar, nsStatusBar, arginfo_appkit_ns_nsstatusbar_nsstatusbar_nsstatusbar, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	...
	PHP_ME(AppKit_NS_NSStatusBar_NSStatusBar, statusItemWithKind, arginfo_appkit_ns_nsstatusbar_nsstatusbar_statusitemwithkind, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
