...
{
	ZEPHIR_REGISTER_CLASS(AppKit\\NS\\NSAccessibility, NSAccessibility, appkit, ns_nsaccessibility_nsaccessibility, appkit_ns_nsaccessibility_nsaccessibility_method_entry, 0);
...
PHP_METHOD(AppKit_NS_NSAccessibility_NSAccessibility, attach)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &handle_param);
            ...
            result = ns_protocol_attach((uintptr_t) handle, "NSAccessibility") == 1;
...
PHP_METHOD(AppKit_NS_NSAccessibility_NSAccessibility, poll)
{
            ...
            zval event;
            array_init(&event);
            if (ns_protocol_poll("NSAccessibility", protocol, (int) sizeof(protocol), selector, (int) sizeof(selector), &sender, &arg0, arg1, (int) sizeof(arg1))) {
