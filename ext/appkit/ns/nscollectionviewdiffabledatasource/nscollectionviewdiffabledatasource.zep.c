...
#include "ns-collectionviewdiffable.h"
#include <stdint.h>
...
{
	ZEPHIR_REGISTER_CLASS(AppKit\\NS\\NSCollectionViewDiffableDataSource, NSCollectionViewDiffableDataSource, appkit, ns_nscollectionviewdiffabledatasource_nscollectionviewdiffabledatasource, appkit_ns_nscollectionviewdiffabledatasource_nscollectionviewdiffabledatasource_method_entry, 0);
...
PHP_METHOD(AppKit_NS_NSCollectionViewDiffableDataSource_NSCollectionViewDiffableDataSource, destroy)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &source_param);
            ...
            ns_collectionviewdiffable_destroy((uintptr_t) source);
...
PHP_METHOD(AppKit_NS_NSCollectionViewDiffableDataSource_NSCollectionViewDiffableDataSource, itemCount)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &source_param);
            ...
            value = (zend_long) ns_collectionviewdiffable_item_count((uintptr_t) source);
