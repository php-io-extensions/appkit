...
#include "src/gc-extendedgamepad.h"
...
{
	ZEPHIR_REGISTER_CLASS(AppKit\\GC\\GCExtendedGamepad, GCExtendedGamepad, appkit, gc_gcextendedgamepad_gcextendedgamepad, appkit_gc_gcextendedgamepad_gcextendedgamepad_method_entry, 0);
...
PHP_METHOD(AppKit_GC_GCExtendedGamepad_GCExtendedGamepad, controller)
{
	...
	ZVAL_LONG(&_0, handle);
	RETURN_LONG(ns_gcextendedgamepad_controller(&_0));
}
...
PHP_METHOD(AppKit_GC_GCExtendedGamepad_GCExtendedGamepad, dpad)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &handle_param);
	ZVAL_LONG(&_0, handle);
	RETURN_LONG(ns_gcextendedgamepad_dpad(&_0));
}
...
PHP_METHOD(AppKit_GC_GCExtendedGamepad_GCExtendedGamepad, buttonA)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &handle_param);
	ZVAL_LONG(&_0, handle);
	RETURN_LONG(ns_gcextendedgamepad_button_a(&_0));
}
...
PHP_METHOD(AppKit_GC_GCExtendedGamepad_GCExtendedGamepad, buttonB)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &handle_param);
	ZVAL_LONG(&_0, handle);
	RETURN_LONG(ns_gcextendedgamepad_button_b(&_0));
}
...
PHP_METHOD(AppKit_GC_GCExtendedGamepad_GCExtendedGamepad, buttonX)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &handle_param);
	ZVAL_LONG(&_0, handle);
	RETURN_LONG(ns_gcextendedgamepad_button_x(&_0));
}
...
PHP_METHOD(AppKit_GC_GCExtendedGamepad_GCExtendedGamepad, buttonY)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &handle_param);
	ZVAL_LONG(&_0, handle);
	RETURN_LONG(ns_gcextendedgamepad_button_y(&_0));
}
...
PHP_METHOD(AppKit_GC_GCExtendedGamepad_GCExtendedGamepad, buttonMenu)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &handle_param);
	ZVAL_LONG(&_0, handle);
	RETURN_LONG(ns_gcextendedgamepad_button_menu(&_0));
}
...
PHP_METHOD(AppKit_GC_GCExtendedGamepad_GCExtendedGamepad, buttonOptions)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &handle_param);
	ZVAL_LONG(&_0, handle);
	RETURN_LONG(ns_gcextendedgamepad_button_options(&_0));
}
...
PHP_METHOD(AppKit_GC_GCExtendedGamepad_GCExtendedGamepad, buttonHome)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &handle_param);
	ZVAL_LONG(&_0, handle);
	RETURN_LONG(ns_gcextendedgamepad_button_home(&_0));
}
...
PHP_METHOD(AppKit_GC_GCExtendedGamepad_GCExtendedGamepad, leftThumbstick)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &handle_param);
	ZVAL_LONG(&_0, handle);
	RETURN_LONG(ns_gcextendedgamepad_left_thumbstick(&_0));
}
...
PHP_METHOD(AppKit_GC_GCExtendedGamepad_GCExtendedGamepad, rightThumbstick)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &handle_param);
	ZVAL_LONG(&_0, handle);
	RETURN_LONG(ns_gcextendedgamepad_right_thumbstick(&_0));
}
...
PHP_METHOD(AppKit_GC_GCExtendedGamepad_GCExtendedGamepad, leftShoulder)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &handle_param);
	ZVAL_LONG(&_0, handle);
	RETURN_LONG(ns_gcextendedgamepad_left_shoulder(&_0));
}
...
PHP_METHOD(AppKit_GC_GCExtendedGamepad_GCExtendedGamepad, rightShoulder)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &handle_param);
	ZVAL_LONG(&_0, handle);
	RETURN_LONG(ns_gcextendedgamepad_right_shoulder(&_0));
}
...
PHP_METHOD(AppKit_GC_GCExtendedGamepad_GCExtendedGamepad, leftTrigger)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &handle_param);
	ZVAL_LONG(&_0, handle);
	RETURN_LONG(ns_gcextendedgamepad_left_trigger(&_0));
}
...
PHP_METHOD(AppKit_GC_GCExtendedGamepad_GCExtendedGamepad, rightTrigger)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &handle_param);
	ZVAL_LONG(&_0, handle);
	RETURN_LONG(ns_gcextendedgamepad_right_trigger(&_0));
}
...
PHP_METHOD(AppKit_GC_GCExtendedGamepad_GCExtendedGamepad, leftThumbstickButton)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &handle_param);
	ZVAL_LONG(&_0, handle);
	RETURN_LONG(ns_gcextendedgamepad_left_thumbstick_button(&_0));
}
...
PHP_METHOD(AppKit_GC_GCExtendedGamepad_GCExtendedGamepad, rightThumbstickButton)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &handle_param);
	ZVAL_LONG(&_0, handle);
	RETURN_LONG(ns_gcextendedgamepad_right_thumbstick_button(&_0));
}
