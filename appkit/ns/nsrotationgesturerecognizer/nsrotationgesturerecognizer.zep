namespace AppKit\NS\NSRotationGestureRecognizer;
...
class NSRotationGestureRecognizer
{
    ...
    public static function rotation(int recognizer) -> double
    {
        double value;
        %{
    ...
    public static function rotationInDegrees(int recognizer) -> double
    {
        double value;
        %{
    ...
    public static function setRotation(int recognizer, float radians) -> void
    {
        %{
    ...
    public static function nsRotationGestureRecognizer(int recognizer) -> int
    {
        int ptr;
        %{
